        ...
        <CardContent className="flex flex-col items-center py-2 space-y-6 text-center">
          ...
          {showRetry && (
            <Button
              onClick={onRetry}
              variant="outline"
              className="mt-4 transition-colors select-none group border-rose-300 text-rose-500 hover:bg-rose-100 hover:border-rose-400 hover:text-rose-600 active:bg-rose-100 active:border-rose-400 active:text-rose-600 hover:shadow-sm active:shadow-sm"
            >
